...
const welcome_h1 = "Welcome to the Eggy Faces NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Eggy Faces NFT Project is just for fun and to put a smile on your face! 😊';
...
const button_presale_already_minted = "You're already an Eggy Face collector";
